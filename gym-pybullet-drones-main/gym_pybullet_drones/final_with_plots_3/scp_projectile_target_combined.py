...
class ProjectileTarget:
    def get_state(self, t):
        ...
        # Projectile profile tuned for slow motion with gentle vertical drop.
        x_0 = 0.5
        z_0 = 1.0
        vx = 0.15
        g = 0.01
        ...
        # Keep target above ground plane in PyBullet.
        if s[2] < Z_MIN:
            s[2] = Z_MIN
            s[5] = 0.0
        return s
...
# ======================================================================
# MAIN EXECUTION (PROJECTILE TARGET)
# ======================================================================
def run():
    ...
    print("[SIM] Running Projectile Target SCP Docking...")
    START = time.time()
