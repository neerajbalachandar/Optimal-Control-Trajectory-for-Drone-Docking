...
def load_scp_linear_ekf_reference(suppress_plots: bool = True):
    """Run theory/SCP_linear_EKF.py and extract state references."""
...
def run(
    ...
    scp = load_scp_linear_ekf_reference(suppress_plots=not show_scp_plots)
    x_exec = scp["x_exec"]
    ...
    print(
        "[INFO] Loaded SCP_linear_EKF PID tracking reference: "
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "Animate SCP_linear_EKF.py by tracking its state reference trajectory x_hist with PID "
